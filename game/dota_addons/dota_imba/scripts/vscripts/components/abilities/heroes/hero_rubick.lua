...
function imba_rubick_fade_bolt:OnSpellStart()
	if IsServer() then
		...
		Timers:CreateTimer(function()
			...
			if kaboom == true then
				local particle_explosion_fx = ParticleManager:CreateParticle("particles/heroes/hero_rubick/hero_techies/rubick_fade_bolt_explode.vpcf", PATTACH_WORLDORIGIN, current_target)
